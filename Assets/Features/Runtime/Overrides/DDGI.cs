...
namespace DDGI
{
    ...
    [Serializable, VolumeComponentMenu("Lighting/Dynamic Diffuse Global Illumination")] //, SupportedOnRenderPipeline(typeof(UniversalRenderPipeline))]
...
#if UNITY_EDITOR
        public static void RefreshDDGISettings()
        {
